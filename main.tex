...
\begin{figure}[H]
  ...
  % ---- Security section label (moved left to avoid overlap) ----
  \node[font=\scriptsize\bfseries\color{gray!60}, rotate=90,
        left=1.15cm of p2] {SECURITY CONTROLS};
  ...
  % ---- Continuous Feedback Loop (routed below controls to avoid overlap) ----
  \coordinate (loopY)  at ($(current bounding box.south) + (0,-0.45)$);
  \coordinate (loopBR) at (loopY -| m3.south);
  \coordinate (loopBL) at (loopY -| p3.south);
  ...
  \draw[feedarr]
    ...
    -- node[
        midway,
        above=2pt,
        font=\footnotesize\bfseries\color{red!65!black},
        fill=white, fill opacity=0.92, text opacity=1,
        rounded corners=2pt, inner sep=2.5pt
      ] {Continuous Security Feedback Loop} (loopBL)
    -- (p3.south);
